...
**DiGi.User.WebAPI** is a C# engineering and architectural software library suite designed for BIM and CAD integrations (such as Revit, RhinoCommon, Grasshopper, and Dynamo BIM).
...
* **[DiGi.User.WebAPI](DiGi.User.WebAPI)** (Path: `DiGi.User.WebAPI\DiGi.User.WebAPI`)
